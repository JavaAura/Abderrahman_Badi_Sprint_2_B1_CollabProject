...
<div class="container mt-5">
    ...
    <button type="button" class="btn btn-primary mb-4" data-bs-toggle="modal" data-bs-target="#addSquadModal">
        Add New Squad
    </button>
        ...
        <tbody>
            <c:forEach var="squad" items="${squads}">
                <tr>
                    ...
                    <td>${squad.name}</td>
                    <td>
                        <a href="squads?action=get&id=${squad.id}" class="btn btn-info btn-sm">View</a>
                        <button type="button" class="btn btn-warning btn-sm" data-bs-toggle="modal" data-bs-target="#updateSquadModal" 
                                data-id="${squad.id}" data-name="${squad.name}">
                            Edit
                        </button>
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="squads" method="post">
                ...
                <input type="hidden" id="updateSquadId" name="id" value=""> <!-- This will hold the squad ID -->
                <div class="modal-body">
                    <div class="mb-3">
